...
BLOCCO: image is removed
ANNOTATOR: image goes in annotated + work done in time
VERIFIER: image goes in verified + work done in time
IMAGE: no changes
  */
...
/**
 * THIS FUNCTION IS NO MORE USED, USE ACCEPTANNOTATION OR MODIFYANNOTATION
