...
export default function ModalSignOut() {
  return (
    <div id="signout" className="pacity-0 transform hidden -translate-y-full scale-150  relative w-10/2 md:w-1/3 h-1/2 md:h-1/5 bg-white rounded shadow-lg transition-opacity transition-transform duration-300">
      <button
        type="button"
