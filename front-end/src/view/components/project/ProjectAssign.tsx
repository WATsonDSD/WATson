...
//   assignBlockToAnnotator, getPendingImagesFromProject,
// } from '../../../data';
...
//   useEffect(() => {
//     getPendingImagesFromProject(project!).then((result) => {
//       console.log(result);
//       setImagesToAnnotate(result!);
//     });
//     getUsersOfProject(project!).then((result) => { setProjectUsers(result!); });
//   }, []);
